...
export const NAV = [
...

    {
        ...
        items: [
            ...
            { label: 'Media Puls', href: '/media-monitoring.html#media-puls', note: 'Media monitoring' },
...

    {
        ...
        items: [
            ...
            { label: 'Litteraworks', href: 'https://litteraworks.com/', note: 'Transcription & subtitles', ...EXT },
            { label: 'Pchela', href: 'https://pchela.app/', note: 'AI asset management', ...EXT },
            { label: 'Sport Puls', href: '/media-monitoring.html#sport-puls', note: 'Sport monitoring' },
            { label: 'Fronisa', href: '/fronisa.html', note: 'AI chatbot & SEO' },
        ],
    },

    {
        ...
        items: [
            ...
            { label: 'Litteraworks', href: 'https://litteraworks.com/', note: 'Transcription & subtitles', ...EXT },
            { label: 'Pchela', href: 'https://pchela.app/', note: 'AI asset management', ...EXT },
            { label: 'Media monitoring', href: '/media-monitoring.html', note: 'Media Puls / Sport Puls' },
            { label: 'Fronisa', href: '/fronisa.html', note: 'AI chatbot & SEO' },
        ],
    },
...
const CURRENT = {
    ...
    'media-monitoring.html': 'products',
